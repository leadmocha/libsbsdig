...
TSBSCher::Print ()
{
  ...
  cout << " Total number of PMTs = " << fNPMTs << ", set in " << fNPMTrows << " rows,  " 
       << fNPMTcolsMax << " or " << fNPMTcolsMax-1 << " PMTs each." << endl;
  cout << " Distance between PMTs " << fInterPMTDist 
       << " horizontal/vertical extension of PMT matrix : " 
