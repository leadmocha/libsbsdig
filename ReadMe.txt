...
The structure of the data stored is the following:
  UInt_t    fPMTID; // Hit PMT row
  Double_t  fNpe;  // Number of photoelectrons
  Double_t  fTime;  // hit time
  Double_t  fTimeRMS;  // hit time RMS: usually very small (<~0.1 ns)
  ...
  TVector3  fMom_MCtrack;   // momentum of the MC track which gave the hit (*)
  TVector3  fVtx_MCtrack;  // position of the MC track which gave the hit (*)
